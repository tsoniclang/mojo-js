...
def main() raises:
    ...
    describe(date_new(2024, 2, 10, 2, 30))
    describe(date_new(2024, 10, 3, 1, 30))
    describe(date_new(2011, 11, 30, 12))
    var setters = date_new("2024-03-10T00:30:00")
    _ = setters.set_hours(2)
    describe(setters)
    _ = setters.set_minutes(50, 30, 0)
    describe(setters)
    _ = setters.set_month(10, 3)
    _ = setters.set_hours(1, 30, 0, 0)
    describe(setters)
